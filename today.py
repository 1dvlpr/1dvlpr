...
USER_NAME = os.environ['USER_NAME'] # '1dvlpr'
...
if __name__ == '__main__':
    """
    Aditya Tomar (1dvlpr), 2022-2023
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': 'MDQ6VXNlcjU3MzMxMTM0'} and 2019-11-03T21:15:07Z for username '1dvlpr'
    ...
    if OWNER_ID == {'id': 'MDQ6VXNlcjU3MzMxMTM0'}: # only calculate for user 1dvlpr
